...
"KraKra Pro" is a full-fledged joke app equipped with 16 types of videos, 20 types of audio, microphone input, and face recognition.
...
"크라크라 Pro" 는 16종의 동영상, 20종의 오디오, 마이크 입력, 얼굴 인식 기능을 갖춘 본격적인 농담 앱입니다.
...
「くらくらPro」は、16種類の映像と20種類の音声、マイク入力、顔認証を搭載した本格的なジョークアプリです。
...
《克拉克拉Pro》是一款成熟的笑话应用程序，配备16种视频、20种音频、麦克风输入和面部识别。
...
《克拉克拉Pro》是一款成熟的笑話應用程序，配備16種視頻、20種音頻、麥克風輸入和麵部識別。
...
"KraKra Pro" è un'app per scherzi completa dotata di 16 tipi di video, 20 tipi di audio, ingresso microfono e riconoscimento facciale.
...
„KraKra Pro“ ist eine vollwertige Scherz-App, die mit 16 Arten von Videos, 20 Arten von Audio, Mikrofoneingang und Gesichtserkennung ausgestattet ist.
...
"KraKra Pro" es una aplicación de broma completa equipada con 16 tipos de vídeos, 20 tipos de audio, entrada de micrófono y reconocimiento facial.
...
«KraKra Pro» — полноценное приложение-шутка, оснащенное 16 типами видео, 20 типами звука, микрофонным входом и распознаванием лиц.
